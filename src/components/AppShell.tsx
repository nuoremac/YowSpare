    ...
    <PageSearchProvider value={{ query: pageSearch, setQuery: setPageSearch }}>
      <div className="min-h-screen bg-slate-50 text-slate-900">
        ...
        <div className="flex min-h-screen flex-col md:flex-row">
          <aside
            className={`fixed inset-y-0 left-0 z-40 w-64 overflow-y-auto border-r border-slate-200 bg-white px-5 py-6 transition-transform duration-200 ${
          ...
          >
            ...
            <a
              href="/"
              className="grid h-9 w-9 place-items-center overflow-hidden rounded-xl border border-slate-200 bg-white"
              aria-label="Go to landing page"
            >
              <img src="/icons/yowspareicon.png" alt="YowSpare icon" className="h-7 w-7" />
            </a>
            <a href="/" className="text-sm font-semibold tracking-wide text-slate-500">
              YowSpare
            </a>
            </div>
            <div className="rounded-2xl border border-slate-200 bg-slate-50 p-3">
              <div className="flex items-center justify-between gap-3">
                ...
                <button className="grid h-9 w-9 place-items-center rounded-xl border border-slate-200 bg-white text-slate-600">
              ...
              <div className="flex items-center gap-3 px-6 py-4">
                ...
                {!isAsideOpen && (
                  <div className="flex items-center gap-2">
                    <div className="grid h-7 w-7 place-items-center overflow-hidden rounded-lg border border-slate-200 bg-white">
                      <img src="/icons/yowspareicon.png" alt="YowSpare icon" className="h-5 w-5" />
                    </div>
                    <div className="text-xs font-semibold text-slate-500 md:ml-0">YowSpare</div>
                  </div>
                )}
                <div className="relative ml-2 flex-1">
                  ...
                  <input
                    ...
                    className="w-full max-w-xl rounded-full border border-slate-200 bg-white py-2.5 pl-10 pr-4 text-sm text-slate-700 shadow-sm outline-none focus:border-blue-400"
                  />
                </div>
                ...
                <div className="relative">
                  ...
                  {isSettingsMenuOpen && (
                    <div
                      className="absolute right-0 mt-2 w-56 overflow-hidden rounded-xl border border-slate-200 bg-white text-sm text-slate-700 shadow-lg"
                      onMouseLeave={() => setIsSettingsMenuOpen(false)}
                    >
                      <button className="flex w-full items-center gap-2 px-4 py-2 text-left hover:bg-slate-50">
                  ...
                  {isUserMenuOpen && (
                    ...
                    >
                      <div className="border-b border-slate-200 px-4 py-3">
                        <div className="text-xs font-semibold text-slate-500">Administrateur</div>
                      ...
                      <div className="border-t border-slate-200">
                        <button className="flex w-full items-center gap-2 px-4 py-2 text-left text-red-600 hover:bg-red-50">
                          <svg viewBox="0 0 24 24" className="h-4 w-4" fill="none" stroke="currentColor" strokeWidth="1.6">
