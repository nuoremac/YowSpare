    ...
    <div className="mx-auto w-full max-w-6xl pt-12">
      <section className="grid gap-10 lg:grid-cols-[1.1fr_0.9fr]">
        ...
        <div className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
          <p className="text-sm font-semibold text-slate-800">{t("about.mission.title")}</p>
      ...
      <section className="mt-12 rounded-3xl border border-slate-200 bg-white p-8 shadow-sm">
        <div className="grid gap-6 md:grid-cols-3">
          <div>
            <p className="text-sm font-semibold text-slate-800">2019</p>
            <p className="mt-2 text-sm text-slate-600">
              {t("about.timeline.2019")}
            </p>
          </div>
          <div>
            <p className="text-sm font-semibold text-slate-800">2022</p>
            <p className="mt-2 text-sm text-slate-600">
              {t("about.timeline.2022")}
            </p>
          </div>
          <div>
            <p className="text-sm font-semibold text-slate-800">2025</p>
            <p className="mt-2 text-sm text-slate-600">
