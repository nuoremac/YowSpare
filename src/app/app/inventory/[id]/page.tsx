    ...
    <div className="space-y-4">
      <div className="rounded-2xl border border-gray-200 p-5">
        ...
        {part.photoUrl && (
          ...
          <img src={part.photoUrl} alt={part.description} className="mt-4 w-full max-h-64 object-cover rounded-2xl border border-gray-200" />
        )}
      </div>
      ...
      <div className="rounded-2xl border border-gray-200 p-5">
        ...
        <div className="mt-3 space-y-2">
          {stockForPart.map((s) => {
            ...
            return (
              <div key={s.binId} className="flex items-center justify-between rounded-xl border border-gray-200 px-3 py-2">
